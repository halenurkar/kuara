...

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            SqlDataAdapter da4 = new SqlDataAdapter("select firstname, lastname, yorum from magazin y INNER JOIN signup on y.kullanici_id =signup_id  order by  y.yorum_id desc  ", connection);
            ...
            SqlDataAdapter da0 = new SqlDataAdapter("select COUNT(magazin.kullanici_id) as yorum_sayısı from magazin  ", connection);
    ...
    protected void yorum_gonder_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter sqlveriadaptoru = new SqlDataAdapter("INSERT INTO magazin( yorum,kullanici_id) values(@y,@k)", connection);
        ...
        SqlDataAdapter sqlveriadaptoru2 = new SqlDataAdapter("select firstname, lastname, yorum from magazin y INNER JOIN signup on y.kullanici_id =signup_id  order by  y.yorum_id desc  ", connection);
